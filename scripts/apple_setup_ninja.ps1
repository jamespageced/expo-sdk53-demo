...
# Variables
$ninjaZipUri = "https://github.com/ninja-build/ninja/releases/download/v1.13.2/ninja-mac.zip"
$ninjaZipOutputFile = "ninja-win.zip"
$ninjaZipOutputPathWithFile = "$PWD" + "/../" + $ninjaZipOutputFile
$ninjaExeOutputPath = "$PWD" + "/../plugins/ninja-win"
...
Get-ChildItem
Get-ChildItem -Path "/../plugins" -Recurse